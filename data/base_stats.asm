...
INCLUDE "data/baseStats/proglotto.asm"
INCLUDE "data/baseStats/bibrodo.asm"
INCLUDE "data/baseStats/traptor.asm"
INCLUDE "data/baseStats/spiritus.asm"
INCLUDE "data/baseStats/fetuso.asm"