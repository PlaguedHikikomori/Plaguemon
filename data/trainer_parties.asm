...
; Cinnabar Gym
	db 38,VULPIX,ELECTRODE,NINETALES,PORYGON,WEEZING,GYARADOS,0                     ;CYBER SLAVE1
	db $FF,38,PONYTA,39,CHARMELEON,40,RAPIDASH,41,GROWLITHE,42,ARCANINE,0		  					 ;CYBER SLAVE2
	db $FF,42,RAPIDASH,44,MAGMAR,44,PORYGON,45,KABUTOPS,46,OMASTAR,0                                 ;CYBER SLAVE3
	db $FF,46,STARMIE,47,DODRIO,47,DEWGONG,48,OMASTAR,48,RHYDON,49,PORYGON,0         ;CYBER SLAVE4
HikerData:
; Mt. Moon 1F
...
Green3Data:
	db $FF,70,PIDGEOT,66,ALAKAZAM,71,RHYDON,75,ARCANINE,78,EXEGGUTOR,80,BLASTOISE,0
	db $FF,70,PIDGEOT,66,ALAKAZAM,71,RHYDON,75,GYARADOS,78,ARCANINE,80,VENUSAUR,0
	db $FF,70,PIDGEOT,66,ALAKAZAM,71,RHYDON,75,EXEGGUTOR,78,GYARADOS,80,CHARIZARD,0
LoreleiData:
	db $FF,54,SEAKING,53,ARCANINE,54,ELECTRODE,56,JOLTEON,56,GENGAR,0
ChannelerData:
; Unused
	db 22,GASTLY,0
	db 24,GASTLY,0
...
AgathaData:
	db $FF,56,GENGAR,56,GOLBAT,55,HAUNTER,58,ARBOK,60,TRAPTOR,0
LanceData:
