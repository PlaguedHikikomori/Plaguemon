...
; Cinnabar Gym
	db 36,VULPIX,VULPIX,NINETALES,0                   ;CYBER SLAVE1
	db 34,PONYTA,CHARMANDER,VULPIX,GROWLITHE,0		  ;CYBER SLAVE2
	db 41,RAPIDASH,0                                 ;CYBER SLAVE3
	db 37,GROWLITHE,VULPIX,0                          ;CYBER SLAVE4
HikerData:
; Mt. Moon 1F
